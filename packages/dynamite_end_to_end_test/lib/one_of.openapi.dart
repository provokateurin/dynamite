...
sealed class $ObjectOneOf0Interface {
  ...
  $ObjectOneOf0Interface rebuild(
    void Function($ObjectOneOf0InterfaceBuilder) updates,
  );
...
abstract class ObjectOneOf0
    implements
        $ObjectOneOf0Interface,
        Built<ObjectOneOf0, ObjectOneOf0Builder> {
  /// Creates a new ObjectOneOf0 object using the builder pattern.
  factory ObjectOneOf0([void Function(ObjectOneOf0Builder)? b]) =
      _$ObjectOneOf0;
  ...
  factory ObjectOneOf0.fromJson(Map<String, dynamic> json) =>
...
sealed class $ObjectOneOf1Interface {
  ...
  $ObjectOneOf1Interface rebuild(
    void Function($ObjectOneOf1InterfaceBuilder) updates,
  );
...
abstract class ObjectOneOf1
    implements
        $ObjectOneOf1Interface,
        Built<ObjectOneOf1, ObjectOneOf1Builder> {
  /// Creates a new ObjectOneOf1 object using the builder pattern.
  factory ObjectOneOf1([void Function(ObjectOneOf1Builder)? b]) =
      _$ObjectOneOf1;
  ...
  ///
  /// Use [toJson] to serialize it back into json.
  factory ObjectOneOf1.fromJson(Map<String, dynamic> json) =>
      _$jsonSerializers.deserializeWith(serializer, json)!;
...
sealed class $MixedOneOf1Interface {
  ...
  $MixedOneOf1Interface rebuild(
    void Function($MixedOneOf1InterfaceBuilder) updates,
  );
...
abstract class MixedOneOf1
    implements $MixedOneOf1Interface, Built<MixedOneOf1, MixedOneOf1Builder> {
  ...
  ///
  /// Use [toJson] to serialize it back into json.
  factory MixedOneOf1.fromJson(Map<String, dynamic> json) =>
      _$jsonSerializers.deserializeWith(serializer, json)!;
...
sealed class $OneObjectOneOf0Interface {
  ...
  $OneObjectOneOf0Interface rebuild(
    void Function($OneObjectOneOf0InterfaceBuilder) updates,
  );
...
abstract class OneObjectOneOf0
    implements
        $OneObjectOneOf0Interface,
        Built<OneObjectOneOf0, OneObjectOneOf0Builder> {
  /// Creates a new OneObjectOneOf0 object using the builder pattern.
  factory OneObjectOneOf0([void Function(OneObjectOneOf0Builder)? b]) =
      _$OneObjectOneOf0;
  ...
  ///
  /// Use [toJson] to serialize it back into json.
  factory OneObjectOneOf0.fromJson(Map<String, dynamic> json) =>
      _$jsonSerializers.deserializeWith(serializer, json)!;
  ...
  static Serializer<OneObjectOneOf0> get serializer =>
...
sealed class $OneOfUnspecifiedArray0Interface {
  ...
  $OneOfUnspecifiedArray0Interface rebuild(
    void Function($OneOfUnspecifiedArray0InterfaceBuilder) updates,
  );
...
abstract class OneOfUnspecifiedArray0
    implements
        $OneOfUnspecifiedArray0Interface,
        Built<OneOfUnspecifiedArray0, OneOfUnspecifiedArray0Builder> {
  /// Creates a new OneOfUnspecifiedArray0 object using the builder pattern.
  factory OneOfUnspecifiedArray0([
    void Function(OneOfUnspecifiedArray0Builder)? b,
  ...
  static Serializer<OneOfUnspecifiedArray0> get serializer =>
...
sealed class $OneOfStringArray0Interface {
  ...
  $OneOfStringArray0Interface rebuild(
    void Function($OneOfStringArray0InterfaceBuilder) updates,
  );
...
abstract class OneOfStringArray0
    implements
        $OneOfStringArray0Interface,
        Built<OneOfStringArray0, OneOfStringArray0Builder> {
  /// Creates a new OneOfStringArray0 object using the builder pattern.
  factory OneOfStringArray0([void Function(OneOfStringArray0Builder)? b]) =
      _$OneOfStringArray0;
  ...
  ///
  /// Use [toJson] to serialize it back into json.
  factory OneOfStringArray0.fromJson(Map<String, dynamic> json) =>
      _$jsonSerializers.deserializeWith(serializer, json)!;
  ...
  static Serializer<OneOfStringArray0> get serializer =>
...
extension $ObjectOneOfExtension on ObjectOneOf {
  ...
  static Serializer<ObjectOneOf> get serializer =>
      $6c828020e1dac1d58ded0a29ef8b0c41Extension._serializer;

  /// Creates a new object from the given [json] data.
  ///
  /// Use `toJson` to serialize it back into json.
  static ObjectOneOf fromJson(Object? json) =>
      $6c828020e1dac1d58ded0a29ef8b0c41Extension._fromJson(json);
}
...
extension $MixedOneOfExtension on MixedOneOf {
  ...
  @BuiltValueSerializer(custom: true)
  static Serializer<MixedOneOf> get serializer =>
      $d1b40dfcebdca2dfa1f3e52ac98462a5Extension._serializer;

  /// Creates a new object from the given [json] data.
  ///
  /// Use `toJson` to serialize it back into json.
  static MixedOneOf fromJson(Object? json) =>
      $d1b40dfcebdca2dfa1f3e52ac98462a5Extension._fromJson(json);
}
...
extension $OneOfIntDoubleOtherExtension on OneOfIntDoubleOther {
  ...
  @BuiltValueSerializer(custom: true)
  static Serializer<OneOfIntDoubleOther> get serializer =>
      $b6d67dc2a96424d2f407f8e51557f3deExtension._serializer;

  /// Creates a new object from the given [json] data.
  ///
  /// Use `toJson` to serialize it back into json.
  static OneOfIntDoubleOther fromJson(Object? json) =>
...
extension $OneOfUnspecifiedArrayExtension on OneOfUnspecifiedArray {
  ...
  @BuiltValueSerializer(custom: true)
  static Serializer<OneOfUnspecifiedArray> get serializer =>
      $00f31f9753d01398a2c3705cd335c56eExtension._serializer;

  /// Creates a new object from the given [json] data.
  ///
  /// Use `toJson` to serialize it back into json.
  static OneOfUnspecifiedArray fromJson(Object? json) =>
      $00f31f9753d01398a2c3705cd335c56eExtension._fromJson(json);
}
...
extension $OneOfStringArrayExtension on OneOfStringArray {
  ...
  @BuiltValueSerializer(custom: true)
  static Serializer<OneOfStringArray> get serializer =>
      $5fb8a7f8bbb305dd61a4a05d6996c58bExtension._serializer;

  /// Creates a new object from the given [json] data.
  ///
  /// Use `toJson` to serialize it back into json.
  static OneOfStringArray fromJson(Object? json) =>
      $5fb8a7f8bbb305dd61a4a05d6996c58bExtension._fromJson(json);
}

typedef _$6c828020e1dac1d58ded0a29ef8b0c41 = ({
  ObjectOneOf0? objectOneOf0,
  ObjectOneOf1? objectOneOf1,
});
...
extension $6c828020e1dac1d58ded0a29ef8b0c41Extension
    on _$6c828020e1dac1d58ded0a29ef8b0c41 {
...
class _$6c828020e1dac1d58ded0a29ef8b0c41Serializer
    implements PrimitiveSerializer<_$6c828020e1dac1d58ded0a29ef8b0c41> {
  const _$6c828020e1dac1d58ded0a29ef8b0c41Serializer();
...
typedef _$d1b40dfcebdca2dfa1f3e52ac98462a5 = ({
...
/// @nodoc
// ignore: library_private_types_in_public_api
extension $d1b40dfcebdca2dfa1f3e52ac98462a5Extension
    on _$d1b40dfcebdca2dfa1f3e52ac98462a5 {
...
class _$d1b40dfcebdca2dfa1f3e52ac98462a5Serializer
    implements PrimitiveSerializer<_$d1b40dfcebdca2dfa1f3e52ac98462a5> {
  const _$d1b40dfcebdca2dfa1f3e52ac98462a5Serializer();
...
/// @nodoc
// ignore: library_private_types_in_public_api
extension $00f31f9753d01398a2c3705cd335c56eExtension
    on _$00f31f9753d01398a2c3705cd335c56e {
...
class _$00f31f9753d01398a2c3705cd335c56eSerializer
    implements PrimitiveSerializer<_$00f31f9753d01398a2c3705cd335c56e> {
  const _$00f31f9753d01398a2c3705cd335c56eSerializer();
...
/// @nodoc
// ignore: library_private_types_in_public_api
extension $5fb8a7f8bbb305dd61a4a05d6996c58bExtension
    on _$5fb8a7f8bbb305dd61a4a05d6996c58b {
...
class _$5fb8a7f8bbb305dd61a4a05d6996c58bSerializer
    implements PrimitiveSerializer<_$5fb8a7f8bbb305dd61a4a05d6996c58b> {
  const _$5fb8a7f8bbb305dd61a4a05d6996c58bSerializer();
  ...
  _$5fb8a7f8bbb305dd61a4a05d6996c58b deserialize(
    ...
    return (
      builtListString: builtListString,
      oneOfStringArray0: oneOfStringArray0,
    );
  }
}
...
final Serializers _$serializers =
    (Serializers().toBuilder()
          ...
          ..addBuilderFactory(
            const FullType(OneOfStringArray0),
            OneOfStringArray0Builder.new,
          )
