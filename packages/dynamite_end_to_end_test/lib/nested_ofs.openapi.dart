...
sealed class $BaseAllOfInterface {
  ...
  $BaseAllOfInterface rebuild(
    void Function($BaseAllOfInterfaceBuilder) updates,
  );
...
abstract class BaseAllOf
    implements $BaseAllOfInterface, Built<BaseAllOf, BaseAllOfBuilder> {
  ...
  factory BaseAllOf.fromJson(Map<String, dynamic> json) =>
...
sealed class $BaseOneOf1Interface {
  ...
  $BaseOneOf1Interface rebuild(
    void Function($BaseOneOf1InterfaceBuilder) updates,
  );
...
abstract class BaseOneOf1
    implements $BaseOneOf1Interface, Built<BaseOneOf1, BaseOneOf1Builder> {
  ...
  ///
  /// Use [toJson] to serialize it back into json.
  factory BaseOneOf1.fromJson(Map<String, dynamic> json) =>
      _$jsonSerializers.deserializeWith(serializer, json)!;
...
sealed class $BaseAnyOf1Interface {
  ...
  $BaseAnyOf1Interface rebuild(
    void Function($BaseAnyOf1InterfaceBuilder) updates,
  );
...
abstract class BaseAnyOf1
    implements $BaseAnyOf1Interface, Built<BaseAnyOf1, BaseAnyOf1Builder> {
  ...
  ///
  /// Use [toJson] to serialize it back into json.
  factory BaseAnyOf1.fromJson(Map<String, dynamic> json) =>
      _$jsonSerializers.deserializeWith(serializer, json)!;
...
sealed class $BaseNestedAllOfInterface implements $BaseAllOfInterface {
  ...
  $BaseNestedAllOfInterface rebuild(
    void Function($BaseNestedAllOfInterfaceBuilder) updates,
  );
...
abstract class BaseNestedAllOf
    implements
        $BaseNestedAllOfInterface,
        Built<BaseNestedAllOf, BaseNestedAllOfBuilder> {
  /// Creates a new BaseNestedAllOf object using the builder pattern.
  factory BaseNestedAllOf([void Function(BaseNestedAllOfBuilder)? b]) =
      _$BaseNestedAllOf;
  ...
  ///
  /// Use [toJson] to serialize it back into json.
  factory BaseNestedAllOf.fromJson(Map<String, dynamic> json) =>
      _$jsonSerializers.deserializeWith(serializer, json)!;
  ...
  static Serializer<BaseNestedAllOf> get serializer =>
...
sealed class $BaseNestedOneOf3Interface {
  ...
  $BaseNestedOneOf3Interface rebuild(
    void Function($BaseNestedOneOf3InterfaceBuilder) updates,
  );
...
abstract class BaseNestedOneOf3
    implements
        $BaseNestedOneOf3Interface,
        Built<BaseNestedOneOf3, BaseNestedOneOf3Builder> {
  /// Creates a new BaseNestedOneOf3 object using the builder pattern.
  factory BaseNestedOneOf3([void Function(BaseNestedOneOf3Builder)? b]) =
      _$BaseNestedOneOf3;
  ...
  ///
  /// Use [toJson] to serialize it back into json.
  factory BaseNestedOneOf3.fromJson(Map<String, dynamic> json) =>
      _$jsonSerializers.deserializeWith(serializer, json)!;
  ...
  static Serializer<BaseNestedOneOf3> get serializer =>
...
sealed class $BaseNestedAnyOf3Interface {
  ...
  $BaseNestedAnyOf3Interface rebuild(
    void Function($BaseNestedAnyOf3InterfaceBuilder) updates,
  );
...
abstract class BaseNestedAnyOf3
    implements
        $BaseNestedAnyOf3Interface,
        Built<BaseNestedAnyOf3, BaseNestedAnyOf3Builder> {
  /// Creates a new BaseNestedAnyOf3 object using the builder pattern.
  factory BaseNestedAnyOf3([void Function(BaseNestedAnyOf3Builder)? b]) =
      _$BaseNestedAnyOf3;
  ...
  ///
  /// Use [toJson] to serialize it back into json.
  factory BaseNestedAnyOf3.fromJson(Map<String, dynamic> json) =>
      _$jsonSerializers.deserializeWith(serializer, json)!;
  ...
  static Serializer<BaseNestedAnyOf3> get serializer =>
...
extension $BaseOneOfExtension on BaseOneOf {
  ...
  static Serializer<BaseOneOf> get serializer =>
      $fc0451dbdd462718bd075afd2e3ce0ecExtension._serializer;

  /// Creates a new object from the given [json] data.
  ///
  /// Use `toJson` to serialize it back into json.
  static BaseOneOf fromJson(Object? json) =>
      $fc0451dbdd462718bd075afd2e3ce0ecExtension._fromJson(json);
}
...
extension $BaseAnyOfExtension on BaseAnyOf {
  ...
  @BuiltValueSerializer(custom: true)
  static Serializer<BaseAnyOf> get serializer =>
      $ce3c7b262d1c503446a436c461be5be9Extension._serializer;

  /// Creates a new object from the given [json] data.
  ///
  /// Use `toJson` to serialize it back into json.
  static BaseAnyOf fromJson(Object? json) =>
      $ce3c7b262d1c503446a436c461be5be9Extension._fromJson(json);
}
...
extension $BaseNestedOneOfExtension on BaseNestedOneOf {
  ...
  @BuiltValueSerializer(custom: true)
  static Serializer<BaseNestedOneOf> get serializer =>
      $8da5087c0b3f2cce06998d453af8ad19Extension._serializer;

  /// Creates a new object from the given [json] data.
  ///
  /// Use `toJson` to serialize it back into json.
  static BaseNestedOneOf fromJson(Object? json) =>
      $8da5087c0b3f2cce06998d453af8ad19Extension._fromJson(json);
}
...
extension $BaseNestedAnyOfExtension on BaseNestedAnyOf {
  ...
  @BuiltValueSerializer(custom: true)
  static Serializer<BaseNestedAnyOf> get serializer =>
      $523892e2348458a2bdb28f9f942dca37Extension._serializer;

  /// Creates a new object from the given [json] data.
  ///
  /// Use `toJson` to serialize it back into json.
  static BaseNestedAnyOf fromJson(Object? json) =>
      $523892e2348458a2bdb28f9f942dca37Extension._fromJson(json);
}
...
extension $NestedOptimizedOneOfExtension on NestedOptimizedOneOf {
  ...
  @BuiltValueSerializer(custom: true)
  static Serializer<NestedOptimizedOneOf> get serializer =>
      $abe6d27882a5771a98ede04cd64de567Extension._serializer;

  /// Creates a new object from the given [json] data.
  ///
  /// Use `toJson` to serialize it back into json.
  static NestedOptimizedOneOf fromJson(Object? json) =>
      $abe6d27882a5771a98ede04cd64de567Extension._fromJson(json);
}

typedef _$fc0451dbdd462718bd075afd2e3ce0ec = ({
  BaseOneOf1? baseOneOf1,
  double? $double,
});
...
extension $fc0451dbdd462718bd075afd2e3ce0ecExtension
    on _$fc0451dbdd462718bd075afd2e3ce0ec {
...
class _$fc0451dbdd462718bd075afd2e3ce0ecSerializer
    implements PrimitiveSerializer<_$fc0451dbdd462718bd075afd2e3ce0ec> {
  const _$fc0451dbdd462718bd075afd2e3ce0ecSerializer();
  ...
  _$fc0451dbdd462718bd075afd2e3ce0ec deserialize(
    ...
    try {
      $double =
          serializers.deserialize(data, specifiedType: const FullType(double))
              as double;
    } catch (_) {}
...
typedef _$ce3c7b262d1c503446a436c461be5be9 = ({
  BaseAnyOf1? baseAnyOf1,
  int? $int,
});
...
/// @nodoc
// ignore: library_private_types_in_public_api
extension $ce3c7b262d1c503446a436c461be5be9Extension
    on _$ce3c7b262d1c503446a436c461be5be9 {
...
class _$ce3c7b262d1c503446a436c461be5be9Serializer
    implements PrimitiveSerializer<_$ce3c7b262d1c503446a436c461be5be9> {
  const _$ce3c7b262d1c503446a436c461be5be9Serializer();
...
/// @nodoc
// ignore: library_private_types_in_public_api
extension $8da5087c0b3f2cce06998d453af8ad19Extension
    on _$8da5087c0b3f2cce06998d453af8ad19 {
...
class _$8da5087c0b3f2cce06998d453af8ad19Serializer
    implements PrimitiveSerializer<_$8da5087c0b3f2cce06998d453af8ad19> {
  const _$8da5087c0b3f2cce06998d453af8ad19Serializer();
...
/// @nodoc
// ignore: library_private_types_in_public_api
extension $523892e2348458a2bdb28f9f942dca37Extension
    on _$523892e2348458a2bdb28f9f942dca37 {
  List<dynamic> get _values => [
    baseAllOf,
    baseAnyOf1,
    baseNestedAnyOf3,
...
class _$523892e2348458a2bdb28f9f942dca37Serializer
    implements PrimitiveSerializer<_$523892e2348458a2bdb28f9f942dca37> {
  const _$523892e2348458a2bdb28f9f942dca37Serializer();
...
typedef _$abe6d27882a5771a98ede04cd64de567 = ({
  BaseOneOf1? baseOneOf1,
  num? $num,
});
...
/// @nodoc
// ignore: library_private_types_in_public_api
extension $abe6d27882a5771a98ede04cd64de567Extension
    on _$abe6d27882a5771a98ede04cd64de567 {
...
class _$abe6d27882a5771a98ede04cd64de567Serializer
    implements PrimitiveSerializer<_$abe6d27882a5771a98ede04cd64de567> {
  const _$abe6d27882a5771a98ede04cd64de567Serializer();
...
final Serializers _$serializers =
    (Serializers().toBuilder()
          ...
          ..addBuilderFactory(
            const FullType(BaseNestedAllOf),
            BaseNestedAllOfBuilder.new,
          )
          ..add(BaseNestedAllOf.serializer)
          ..addBuilderFactory(
            const FullType(BaseNestedOneOf3),
            BaseNestedOneOf3Builder.new,
          )
          ..add(BaseNestedOneOf3.serializer)
          ..add($8da5087c0b3f2cce06998d453af8ad19Extension._serializer)
          ..addBuilderFactory(
            const FullType(BaseNestedAnyOf3),
            BaseNestedAnyOf3Builder.new,
          )
