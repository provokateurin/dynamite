...
For a full example checkout the [example package](https://github.com/provokateurin/dynamite/tree/main/packages/dynamite/example) using the OpenAPI petstore specification.
