...
class OpenAPIBuilder implements Builder {
  OpenAPIBuilder(BuilderOptions options)
  ...
  static final Version maxSupportedVersion = minSupportedVersion
      .incrementMajor();
  ...
  Future<void> build(BuildStep buildStep) async {
    ...
    try {
      ...
      if (version < minSupportedVersion || version > maxSupportedVersion) {
        throw Exception(
          'Only OpenAPI between $minSupportedVersion and $maxSupportedVersion are supported.',
        );
      }
      ...
      final output = Library((b) {
        ...
        if (state.buildConfig.experimental) {
          b.annotations.add(refer('experimental', 'package:meta/meta.dart'));
        }
      });
      ...
      unawaited(
        buildStep.writeAsString(state.outputId, formatter.format(outputString)),
      );
