...
Serializers _$serializers =
    (Serializers().toBuilder()
          ...
          ..add(OpenAPI.serializer)
          ..add(Operation.serializer)
          ..add(Parameter.serializer)
          ..add(ParameterStyle.serializer)
          ..add(ParameterType.serializer)
          ..add(PathItem.serializer)
          ...
          ..addBuilderFactory(
            const FullType(BuiltMap, const [const FullType(String), const FullType(PathItem)]),
            () => MapBuilder<String, PathItem>(),
          )
          ..addBuilderFactory(const FullType(BuiltList, const [const FullType(String)]), () => ListBuilder<String>())
          ..addBuilderFactory(
            const FullType(BuiltMap, const [const FullType(String), const FullType(MediaType)]),
          ...
          ..addBuilderFactory(
            const FullType(BuiltMap, const [const FullType(String), const FullType(Header)]),
          ...
          ..addBuilderFactory(
            const FullType(BuiltMap, const [const FullType(String), const FullType(Response)]),
